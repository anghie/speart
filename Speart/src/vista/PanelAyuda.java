...
//        DefaultMutableTreeNode hojaAdminDB = new DefaultMutableTreeNode("ADMINISTRAR DB");
//        DefaultMutableTreeNode hojaModificarClave = new DefaultMutableTreeNode("MODIFICAR CLAVE");
//        DefaultMutableTreeNode hojaModificarPaciente = new DefaultMutableTreeNode("MODIFICAR PACIENTE");
//        DefaultMutableTreeNode hojaDiagnosticar = new DefaultMutableTreeNode("DIAGNOSTICAR");
 
//       
//        Indice.add(hojaIntroduccion);
//        Indice.add(hojapRrivilegios);
        Indice.add(hojaAdministrador);
//        Indice.add(hojaAdminDB);
//        Indice.add(hojaModificarClave);
//        Indice.add(hojaModificarPaciente);
//        Indice.add(hojaDiagnosticar);

        JTree arbol = new JTree(Indice);
        arbol.setToggleClickCount(1);
        arbol.getSelectionModel().setSelectionMode(1);
        try{
	        url=new URL("File:"+System.getProperty("user.dir")+"/ManualUsuario/index.html");
	        area.setPage(url);
        }catch (Exception e) {
        	e.printStackTrace();
		}
...
//                    	url=new URL("file:"+"ManualUsuario/index"+".html");
//                        area.setPage(url);
//                    }else if(enuso.equals("INTRODUCCIÓN"))          {
//                    	url=new URL("file:"+"ManualUsuario/introducion"+".html");
//                        area.setPage(url);                        
//                    } else if(enuso.equals("PRIVILEGIOS")){
//                    	url=new URL("file:"+"ManualUsuario/ingresoAlSistema"+".html");
//                    	area.setPage(url);
                    }else if(enuso.equals("INGRESA USUARIO O SERVIDOR")){
