...
//        if(cmbServidor.getSelectedIndex()>-1){
            ...
            if(usuario==null){
                panelTodasActividades=new PanelTodasLasActividades(calendario,agendaActual);
                panelDia=new PanelDiaHoras(calendario,agendaActual,null);
                panelSemana=new PanelSemana(calendario,agendaActual,null);
                panelMes=new PanelMes(calendario,agendaActual);
                panelRecordatorio=new PanelRecordatorio(calendario,agendaActual);
            }else{
